...
# 模拟装备表的 AtkBonus 列
values = [25.5, 20.0, 33.33, 10.10, 5.55, 7.77, 12.12, 0.0, 22.22, 14.44,
          0.001, 0.000001, -15.5, 0.0, 8.88e-2]
...
# 也测试更大的列（含极大整数）
print("\n=== 含极大整数的混合列 ===")
mixed_vals = [100, 80, 120, 45, 30, 35, 50, 5, 90, 55,
              999999999999999, 1, 70, 0, 60]
mixed_bonus = [25.5, 20.0, 33.33, 10.10, 5.55, 7.77, 12.12, 0.0, 22.22, 14.44,
               0.001, 0.000001, -15.5, 0.0, 8.88e-2]
