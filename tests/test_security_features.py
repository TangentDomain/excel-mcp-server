...
class TestOperationLogger:
    ...
    def test_log_operation(self):
        ...
        operation_details = {"range": "Sheet1!A1:C10", "data_rows": 10}
...
class TestEnhancedRangeValidation:
    ...
    def test_validate_valid_ranges(self):
        """测试有效范围格式"""
        valid_ranges = ["Sheet1!A1:C10", "Data!1:100", "Report!A:Z", "Summary!5", "Analysis!B", "技能配置表!A1:Z100"]
...
class TestSecurityPerformance:
    ...
    def test_large_scale_validation_performance(self):
        ...
        # 测试各种范围格式的验证性能
        test_ranges = ["Sheet1!A1:Z1000", "Data!1:10000", "Report!A:ZZ", "Analysis!1:100000"]
        ...
        for range_expr in test_ranges:
            try:
                result = ExcelValidator.validate_range_expression(range_expr)
                if result["success"]:
                    ExcelValidator.validate_operation_scale(result["range_info"])
