...
from excel_mcp_server_fastmcp.models.types import CellInfo, ModifiedCell, OperationResult, SheetInfo
from excel_mcp_server_fastmcp.utils.exceptions import ExcelFileNotFoundError, SheetNotFoundError
from excel_mcp_server_fastmcp.utils.formula_cache import get_formula_cache
...
class TestExcelCore:
    ...
    def test_writer_update_range_multiple_cells(self, sample_excel_file):
        ...
        writer = ExcelWriter(sample_excel_file)
        new_data = [["新产品", "新价格"], ["产品A", 100], ["产品B", 200]]
    ...
    def test_writer_update_range_mixed_data_types(self, sample_excel_file):
        ...
        writer = ExcelWriter(sample_excel_file)
        mixed_data = [["文本", 123, 45.67, True], ["更多文本", 456, 78.90, False]]
    ...
    def test_core_workflow_integration(self, temp_dir):
        ...
        test_data = [["项目", "金额", "状态"], ["项目A", 1000, "完成"], ["项目B", 2000, "进行中"]]
...
class TestFormulaDispatch:
    ...
    def test_dispatch_table_integrity(self):
        ...
        assert len(table) == 18
        names = ["SUM", "AVERAGE", "COUNT", "MIN", "MAX", "MEDIAN", "STDEV", "VAR", "PERCENTILE", "QUARTILE", "MODE", "SKEW", "KURT", "GEOMEAN", "HARMEAN", "COUNTIF", "SUMIF", "AVERAGEIF"]
    ...
    def test_formula_concatenate(self, sample_excel_file):
        ...
        sheet = wb.active
        result = writer._basic_formula_parse('CONCATENATE("Hello", " ", "World")', sheet)
    ...
    def test_smart_append_multiple_rows(self, sample_excel_file):
        ...
        result = writer.update_range(f"Sheet1!A{target_row}:B{target_row + 2}", data, insert_mode=True)
    ...
    def test_no_smart_append_in_data_range(self, sample_excel_file):
        ...
        result = writer.update_range(f"Sheet1!A{target_row}", [["替换值"]], insert_mode=True)
    ...
    def test_overwrite_mode_no_smart_append(self, sample_excel_file):
        ...
        result = writer.update_range(f"Sheet1!A{max_row + 5}", [["覆盖值"]], insert_mode=False)
