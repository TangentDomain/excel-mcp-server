...
from excel_mcp_server_fastmcp.server import JsonFormatter
...
class TestJsonFormatter:
    ...
    def _make_record(self, msg, **kwargs):
        ...
        record = logger.makeRecord(name="test", level=logging.DEBUG, fn="test.py", lno=1, msg=msg, args=None, exc_info=None)
    ...
    def test_level_names(self):
        """不同日志级别正确输出"""
        formatter = JsonFormatter()
        for level, name in [(logging.DEBUG, "DEBUG"), (logging.INFO, "INFO"), (logging.WARNING, "WARNING"), (logging.ERROR, "ERROR")]:
