...
class TestUpsertUpdate:
    ...
    def test_update_persists(self, workbook):
        ...
        ExcelOperations.upsert_row(workbook, "技能配置", key_column="skill_id", key_value=1002, updates={"damage": 999})
    ...
    def test_update_does_not_affect_other_rows(self, workbook):
        ...
        ExcelOperations.upsert_row(workbook, "技能配置", key_column="skill_id", key_value=1001, updates={"damage": 0})
        from openpyxl import load_workbook
    ...
    def test_update_string_key(self, workbook):
        ...
        result = ExcelOperations.upsert_row(workbook, "技能配置", key_column="skill_name", key_value="斩击", updates={"damage": 250})
        assert result["success"] is True
        assert result["data"]["action"] == "update"
...
class TestUpsertInsert:
    ...
    def test_insert_new_row(self, workbook):
        ...
        result = ExcelOperations.upsert_row(
            workbook, "技能配置", key_column="skill_id", key_value=1004, updates={"skill_id": 1004, "skill_name": "雷电术", "skill_type": "法师", "damage": 180, "cooldown": 3.5}
        )
        assert result["success"] is True
    ...
    def test_insert_persists(self, workbook):
        ...
        ExcelOperations.upsert_row(workbook, "技能配置", key_column="skill_id", key_value=1005, updates={"skill_id": 1005, "skill_name": "治愈术", "damage": 0})
        from openpyxl import load_workbook
...
class TestUpsertDualHeader:
    ...
    def test_update_dual_header(self, dual_header_workbook):
        ...
        result = ExcelOperations.upsert_row(dual_header_workbook, "装备配置", key_column="equip_id", key_value=2001, updates={"attack": 60}, header_row=2)
        assert result["success"] is True
        assert result["data"]["action"] == "update"
    ...
    def test_insert_dual_header(self, dual_header_workbook):
        ...
        result = ExcelOperations.upsert_row(
            dual_header_workbook, "装备配置", key_column="equip_id", key_value=2004, updates={"equip_id": 2004, "equip_name": "暗影匕首", "rarity": "史诗", "attack": 180}, header_row=2
        )
        assert result["success"] is True
        assert result["data"]["action"] == "insert"
...
class TestUpsertErrors:
    ...
    def test_nonexistent_sheet(self, workbook):
        ...
        result = ExcelOperations.upsert_row(workbook, "不存在的表", key_column="skill_id", key_value=1001, updates={"damage": 100})
    ...
    def test_nonexistent_key_column(self, workbook):
        ...
        result = ExcelOperations.upsert_row(workbook, "技能配置", key_column="不存在的列", key_value=1001, updates={"damage": 100})
        assert result["success"] is False
        assert "不存在" in result.get("message", "")
    ...
    def test_empty_updates(self, workbook):
        ...
        result = ExcelOperations.upsert_row(workbook, "技能配置", key_column="skill_id", key_value=1001, updates={})
        assert result["success"] is False
    ...
    def test_none_key_value(self, workbook):
        ...
        result = ExcelOperations.upsert_row(workbook, "技能配置", key_column="skill_id", key_value=None, updates={"damage": 100})
        assert result["success"] is False
...
class TestBatchInsertRows:
    ...
    def test_batch_insert_nonexistent_sheet(self, batch_workbook):
        ...
        result = ExcelOperations.batch_insert_rows(batch_workbook, "不存在的表", [{"monster_id": 1}])
        assert result["success"] is False
        assert "不存在" in result.get("message", "")
