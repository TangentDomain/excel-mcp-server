...
class TestSQLAdvancedFeatures:
    ...
    def multi_table_file(self):
        ...
        with tempfile.NamedTemporaryFile(suffix=".xlsx", delete=False) as tmp:
            ...
            # 部门表
            departments_df = pd.DataFrame({"DepartmentID": [1, 2, 3], "DepartmentName": ["Engineering", "Sales", "Marketing"], "Budget": [500000, 300000, 200000]})
    ...
    def test_inner_join(self, multi_table_file):
        """测试内连接"""
        engine = AdvancedSQLQueryEngine()
        result = engine.execute_sql_query(multi_table_file, "SELECT e.Name, d.DepartmentName, d.Budget FROM Employees e JOIN Departments d ON e.Department = d.DepartmentName")
    ...
    def test_left_join(self, multi_table_file):
        """测试左连接"""
        engine = AdvancedSQLQueryEngine()
        result = engine.execute_sql_query(multi_table_file, "SELECT e.Name, d.DepartmentName, d.Budget FROM Employees e LEFT JOIN Departments d ON e.Department = d.DepartmentName")
    ...
    def test_right_join(self, multi_table_file):
        """测试右连接"""
        engine = AdvancedSQLQueryEngine()
        result = engine.execute_sql_query(multi_table_file, "SELECT e.Name, d.DepartmentName, d.Budget FROM Employees e RIGHT JOIN Departments d ON e.Department = d.DepartmentName")
    ...
    def test_full_outer_join(self, multi_table_file):
        """测试外连接"""
        engine = AdvancedSQLQueryEngine()
        result = engine.execute_sql_query(multi_table_file, "SELECT e.Name, d.DepartmentName FROM Employees e FULL OUTER JOIN Departments d ON e.Department = d.DepartmentName")
    ...
    def test_multiple_joins(self, complex_data_file):
        """测试多表连接"""
        engine = AdvancedSQLQueryEngine()
        result = engine.execute_sql_query(complex_data_file, "SELECT p.ProductName, s.Quantity, s.SaleDate FROM Products p JOIN Sales s ON p.ProductID = s.ProductID")
    ...
    def test_subquery_in_select(self, multi_table_file):
        """测试SELECT中的子查询"""
        engine = AdvancedSQLQueryEngine()
        result = engine.execute_sql_query(multi_table_file, "SELECT Name, (SELECT AVG(Salary) FROM Employees) as avg_salary FROM Employees")
    ...
    def test_subquery_in_where(self, multi_table_file):
        """测试WHERE中的子查询"""
        engine = AdvancedSQLQueryEngine()
        result = engine.execute_sql_query(multi_table_file, "SELECT Name, Salary FROM Employees WHERE Salary > (SELECT AVG(Salary) FROM Employees)")
    ...
    def test_subquery_in_from(self, multi_table_file):
        """测试FROM中的子查询"""
        engine = AdvancedSQLQueryEngine()
        result = engine.execute_sql_query(multi_table_file, "SELECT * FROM (SELECT Name, Department FROM Employees WHERE Salary > 7000) WHERE Department = 'Engineering'")
    ...
    def test_correlated_subquery(self, multi_table_file):
        ...
        result = engine.execute_sql_query(
            multi_table_file, "SELECT e1.Name, e1.Salary FROM Employees e1 WHERE e1.Salary > (SELECT AVG(e2.Salary) FROM Employees e2 WHERE e2.Department = e1.Department)"
        )
