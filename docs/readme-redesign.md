# README 新版安装指南（待合并到 README.md）

## 改进点
1. 去掉 `<div align="center">` 和过多badge，让标题更醒目
2. 加 "这是什么" 段落，3句话说清楚
3. 5分钟上手分4步，每步都说清楚前置条件和具体操作
4. 分客户端教程：Claude Desktop / Cursor / Cherry Studio
5. uv和pip两种方式都给，pip作为备选
6. 加FAQ折叠块覆盖常见问题
7. 竞品对比和技术细节后移
8. **只写MCP使用方式，不写代码/API用法**：README的读者是游戏策划和数据分析师，不是Python开发者
