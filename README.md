...
![测试覆盖](https://img.shields.io/badge/tests-1159%20tests-brightgreen.svg)
...
[![版本](https://img.shields.io/badge/version-v1.6.26-blue.svg)]
...
**当前版本**: v1.6.26 | **测试覆盖**: 1159个测试用例 | **工具数量**: 44个专业工具
...
| **SQL UPDATE** | ✅ 条件批量修改 | ❌ | ❌ |
| **跨文件JOIN** | ✅ @filepath 语法 | ❌ | ❌ |
| **测试覆盖** | 1168 tests | ~50 tests | ~30 tests |
