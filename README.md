...
**ExcelMCP** 是支持**游戏开发**的 Excel 配置表管理 MCP (Model Context Protocol) 服务器。通过 AI 自然语言指令，实现技能配置表、装备数据、怪物属性等游戏配置的智能化操作。基于 **FastMCP** 和 **openpyxl** 构建，拥有 **35个专业工具** 和 **699个测试用例**，**78.58%代码覆盖率**，提供可靠的Excel文件操作能力。
...
- **📈 总测试用例**: 699个
- **🎯 测试结果**: 695 passed, 3 failed, 1 skipped
- **📊 代码覆盖率**: 78.58%
- **📁 文件支持**: .xlsx, .xlsm, .csv
