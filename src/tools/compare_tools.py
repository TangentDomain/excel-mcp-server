...
def register_compare_tools(mcp) -> None:
    ...
    @mcp.tool()
    def excel_convert_format(file_path: str, output_format: str, output_path: str | None = None) -> dict[str, Any]:
        """转换文件格式
    ...
    @mcp.tool()
    def excel_merge_files(file_paths: list, output_path: str, mode: str = "sheets") -> dict[str, Any]:
        """合并多个 Excel 文件
